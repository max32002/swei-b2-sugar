...
獅尾B2加糖宋體基於[思源宋體](https://github.com/adobe-fonts/source-han-serif)的橫筆加粗和墨暈改造。支援简体中文、繁體中文、韓文與日文。
...
![字體比較](https://github.com/max32002/swei-b2-sugar/raw/master/preview/compare_noto_serif.png)
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-b2-sugar/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-b2-sugar/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-b2-sugar/blob/master/change_log.md) 查看更新記錄。
...
* 由於Max對字體編碼方式完全不清楚，相較於原版的思源宋體，可能有掉很多符號或不常用的字。
